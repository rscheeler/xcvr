...
To add your new project to its Github repository, firstly make sure you have created a project named **xcvr** on Github.
Follow these steps to push your new project.

```
git remote add origin git@github.com:github_username/xcvr.git
git branch -M main
...
Created by [Rob Scheeler](https://github.com/github_username)
